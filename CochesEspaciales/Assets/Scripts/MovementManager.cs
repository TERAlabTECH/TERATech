...
public class MovementManager : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        Vector3 forward = arSessionOrigin.Camera.transform.forward;
        Vector3 targetPosition = arSessionOrigin.Camera.transform.position + forward * referenceObjectOffset;
